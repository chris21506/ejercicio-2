...
T SentinelLinkedList<T>::PopFront()
{
	if (count == 0)
	{
		cout << "Cuidado, estás haciendo PopFront cuando ya no hay elementos en esta lista ligada" << endl;
		return {};
	}
...
#include <iostream>
#include "SentinelLinkedList.h" // Asegúrate que esta ruta coincida con tu proyecto
...
int main() {
	...
	lista.PushBack(20);
	lista.PushBack(30);
	cout << "Elementos después de PushBack (esperado 3): " << lista.GetCount() << endl;

	cout << "\n== PRUEBA POPFRONT ==" << endl;
	int val = lista.PopFront();
	cout << "PopFront: " << val << endl; // debería ser 10
	cout << "Elementos restantes (esperado 2): " << lista.GetCount() << endl;

	cout << "\n== PRUEBA PUSHFRONT ==" << endl;
	lista.PushFront(5);
	cout << "Front (esperado 5): " << lista.Front() << endl;

	cout << "\n== PRUEBA POPBACK ==" << endl;
	val = lista.PopBack();
	cout << "PopBack: " << val << endl; // debería ser 30
	cout << "Elementos restantes (esperado 2): " << lista.GetCount() << endl;

	cout << "\n== PRUEBA REMOVE(20) ==" << endl;
	lista.Remove(20);
	cout << "Elementos restantes (esperado 1): " << lista.GetCount() << endl;

	cout << "\n== PRUEBA FIND(5) ==" << endl;
	auto& nodo = lista.Find(5);
	cout << "Nodo encontrado con data: " << nodo.data << endl;

	cout << "\n== PRUEBA REMOVE(5) y PopFront en lista vacía ==" << endl;
	lista.Remove(5);
	cout << "Elementos restantes (esperado 0): " << lista.GetCount() << endl;

	cout << "Intento de PopFront con lista vacía:" << endl;
	lista.PopFront(); // debería advertir

	cout << "Intento de PopBack con lista vacía:" << endl;
	lista.PopBack(); // debería advertir
